...
This is currently a Codex adapter. The mailbox contract is driver-neutral, but a real Claude driver adapter is still required if that is the production controller.
